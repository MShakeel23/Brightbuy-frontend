 ...
 * 
 * Mobile-responsive layout for admin pages with collapsible sidebar navigation.
 */
          ...
          <div className="flex items-center justify-between h-16 px-4 bg-primary-600">
            <div className="flex items-center">
              <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                <Logo size="sm" showText={false} className="" />
              </div>
              <span className="ml-2 text-xl font-bold text-white">BrightBuy Admin</span>
            </div>
